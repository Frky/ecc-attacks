...
exactly in the same way that modular exponentiation is central in most of arithmetic cryptography schemes. For many classical cryptographic schemes, 
...
the ciphering of a message $m$ with a private key $(N, e)$ is the following: 
$$ c = m^e~mod~N $$
